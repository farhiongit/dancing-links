...
/// If set to 0, solutions are displayed on standard terminal output.
...
/// Initializes a new univers.
/// @param [in] elements List of elements of the univers, separated by separators.
/// @return univers
/// @post User must call dlx_univers_destroy(Univers univers) later.
...
/// @param [in] elements Names of elements of the univers contained in the subset.
...
/// @param [in] univers Univers
/// @param [in] subset_name Name of the added subset
/// @param [in] some_elements List of elements of the univers contained in the subset, separated by separators.
/// @return 1 if added sucessfully, 0 otherwise
/// @note Valid separators are defined by #ELEMENT_SEPARATOR.
